...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <img src="imagens/site1.jpg" width="800" height="63" border="0" usemap="#Map3" /></td>
  </tr>
</table>
  ...
  <tr>
    <td><table width="800" border="0" cellspacing="0" cellpadding="0">
      ...
      try
	  {
			...
			{
			       rs = st.executeQuery("select * from produtos where pro_cat like 'DESTAQUE' and pro_estoque >= '1' order by pro_cat");
			}
			else if (request.getParameter("ordenacao").equals("produto"))
			   {
			       rs = st.executeQuery("select * from produtos where pro_cat like 'DESTAQUE' and pro_estoque >= '1' order by pro_nome");
			   }
