...
<body>
<p align="center" class="style1">Manuten&ccedil;&atilde;o de Produtos</p>
<p align="center" class="style1"><a href="cadProdutos.jsp"><img src="imagens/botao_registrar.gif" width="93" height="24" border="0" /></a>
<p align="center"><span class="style2"><span class="ordenacao"><span class="ordenacao"><span class="ordenacao"><span class="orden"><span class="orden"><span class="ordenacao">Ordena&ccedil;&atilde;o: <a href="produtos.jsp?ordenacao=codigo">Código</a> - <a href="produtos.jsp?ordenacao=produto">Produto</a></span></span></span></span></span></span></span><span class="ordenacao"><span class="orden"> - <a href="produtos.jsp?ordenacao=categoria">Categoria</a></span></span>
<table width="704" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr bgcolor="#FFFF00">
    ...
    <td width="59" bgcolor="#0066FF"><div align="center" class="style4">Excluir</div></td>
  </tr>
  <%
      try
	  {
			...
			{
			       rs = st.executeQuery("select * from produtos order by pro_cod");
			}
			...
			{ %> 
                  <tr bgcolor="#CCFFCC">
                    <td align="center" bgcolor="#FFFFFF"><div align="center" class="lista"><%=rs.getString("pro_cod")%></div></td>
                    ...
                    <td bgcolor="#FFFFFF"><div align="center"><a href="alteraProdutos.jsp?codigo=<%=rs.getString("pro_cod")%>&amp;nome=<%=rs.getString("pro_nome")%>&amp;descricao=<%=rs.getString("pro_desc")%>&amp;numero=<%=rs.getString("pro_cat")%>&amp;preco=<%=rs.getString("pro_preco")%>&amp;estoque=<%=rs.getString("pro_estoque")%>&amp;foto=<%=rs.getString("pro_foto")%>&amp;chave=<%=rs.getString("pro_chave")%>"><img src="imagens/cadastro_clientes.gif" width="24" height="24" border="0" /></a></div></td>
                    <td bgcolor="#FFFFFF"><div align="center"><a href="produtos.jsp?acao=excluir&amp;codigo=<%=rs.getString("pro_cod")%>"><img src="imagens/delete.gif" alt="" width="24" height="24" border="0" /></a></div></td>
                  </tr>
<%          }
      }
