...
<body>
<p align="center" class="style1">Pedidos enviados</p>
...
<table width="637" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <%
      try
	  {
			...
			{
			       rs = st.executeQuery("select * from pedidos where ped_status like 'Enviado' order by ped_nome");
			}
			...
			{ %> 
                  <tr bgcolor="#CCFFCC">
                    <td align="center" bgcolor="#FFFFFF"><div align="center" class="lista"><%=rs.getString("ped_cod")%></div></td>
