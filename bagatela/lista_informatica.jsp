  ...
  <tr>
    <td><table width="800" border="0" cellspacing="0" cellpadding="0">
      ...
      try
	  {
			...
			{
			       rs = st.executeQuery("select * from produtos where pro_cat like 'Informática' and pro_estoque >= '1' order by pro_cat");
			}
			else if (request.getParameter("ordenacao").equals("produto"))
			   {
			       rs = st.executeQuery("select * from produtos where pro_cat like 'Informática' and pro_estoque >= '1' order by pro_nome");
			   }
     			else if (request.getParameter("ordenacao").equals("preco"))
			   {
			       rs = st.executeQuery("select * from produtos where pro_cat like 'Informática' and pro_estoque >= '1' order by pro_preco");
			   }
