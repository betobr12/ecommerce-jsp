...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="tr2"><img src="imagens/site3.jpg" width="800" height="40" border="0" usemap="#Map2" /></td>
  </tr>
</table>
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td><table width="800" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="140" valign="top" class="trmenu"><table width="123" border="0" cellpadding="5" cellspacing="1">
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p></td>
        <td width="660" valign="top" bgcolor="#FFFFFF"><table width="214" border="0" align="center">
          <tr>
            <td width="431" align="center"><span class="abc"><span class="center"><span class="ordenacao">Resultado da busca:</span></span></span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
      ...
      try
	  {
			...
			{
			       rs = st.executeQuery("select * from produtos where pro_chave ilike '%"+request.getParameter("tf_pesquisa")+"%' order by pro_nome");
			}
			else if (request.getParameter("ordenacao").equals("produto"))
			   {
			       rs = st.executeQuery("select * from produtos where pro_cat like '%"+request.getParameter("tf_pesquisa")+"%' order by pro_nome");
			   }
     			else if (request.getParameter("ordenacao").equals("preco"))
			   {
			       rs = st.executeQuery("select * from produtos where pro_cat like '%"+request.getParameter("tf_pesquisa")+"%' order by pro_preco");
			   }
...
<map name="Map" id="Map">
  ...
  <area shape="rect" coords="82,4,198,26" href="login.jsp" />
</map>
